...
function xmldb_facetoface_upgrade($oldversion=0) {
    ...
    if ($result && $oldversion < 2008050500) {
        ...
        $field->set_attributes(XMLDB_TYPE_INTEGER, '1', XMLDB_INT, XMLDB_NOTNULL, null, '0', 'thirdparty');
    ...
    if ($result && $oldversion < 2008061000) {
        ...
        $field->set_attributes(XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, '0', 'timemodified');
        $result = $result && $dbman->add_field($table, $field);
    }
    ...
    if ($result && $oldversion < 2008090800) {
        ...
        $field->set_attributes(XMLDB_TYPE_INTEGER, '20', XMLDB_INT, XMLDB_NOTNULL, null, 0, 'timemodified');
    ...
    if ($result && $oldversion < 2009111300) {
        ...
        $field3->set_attributes(XMLDB_TYPE_INTEGER, '1', XMLDB_INT, XMLDB_NOTNULL, null, '1', 'description');
    ...
    if ($result && $oldversion < 2009111600) {
        ...
        $table1->add_field('id', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        ...
        $table1->add_field('type', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, '0');
        $table1->add_field('possiblevalues', XMLDB_TYPE_TEXT, 'medium', null, null, null, null);
        $table1->add_field('required', XMLDB_TYPE_INTEGER, '1', XMLDB_INT, XMLDB_NOTNULL, null, '0');
        $table1->add_field('defaultvalue', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table1->add_field('isfilter', XMLDB_TYPE_INTEGER, '1', XMLDB_INT, XMLDB_NOTNULL, null, '1');
        $table1->add_field('showinsummary', XMLDB_TYPE_INTEGER, '1', XMLDB_INT, XMLDB_NOTNULL, null, '1');
        $table1->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        $result = $result && $dbman->create_table($table1);

        $table2 = new xmldb_table('facetoface_session_data');
        $table2->add_field('id', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table2->add_field('fieldid', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, '0');
        $table2->add_field('sessionid', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, '0');
    ...
    if ($result && $oldversion < 2009122901) {
        ...
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('sessionid', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, null);
        $table->add_field('roleid', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, null);
        $table->add_field('userid', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, null);
        ...
        $table->add_field('sessionid', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, null);
        $table->add_field('userid', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, null);
        $table->add_field('mailedreminder', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, null);
        $table->add_field('discountcode', XMLDB_TYPE_TEXT, 'small', null, null, null, null);
        $table->add_field('notificationtype', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, null);
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->add_key('sessionid', XMLDB_KEY_FOREIGN, array('sessionid'), 'facetoface_sessions', array('id'));
        $result = $result && $dbman->create_table($table);
        ...
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('signupid', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, null);
        $table->add_field('statuscode', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, null);
        $table->add_field('superceded', XMLDB_TYPE_INTEGER, '1', XMLDB_INT, XMLDB_NOTNULL, null, null);
        $table->add_field('createdby', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, null);
        ...
        $table->add_field('timecreated', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, null);
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        ...
        $field1->set_attributes(XMLDB_TYPE_INTEGER, '1', XMLDB_INT, XMLDB_NOTNULL, null, 0, 'capacity');
        $result = $result && $dbman->add_field($table, $field1);
    }
    ...
    if ($result && $oldversion < 2010012001) {
        ...
        $field->set_attributes(XMLDB_TYPE_INTEGER, '1', XMLDB_INT, XMLDB_NOTNULL, null, 0, 'showoncalendar');
        $result = $result && $dbman->add_field($table, $field);
    }
    ...
    if ($result && $oldversion < 2010051000) {
        ...
        $table2->add_field('id', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table2->add_field('fieldid', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, '0');
        $table2->add_field('noticeid', XMLDB_TYPE_INTEGER, '10', XMLDB_INT, XMLDB_NOTNULL, null, '0');
        $table2->add_field('data', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table2->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
    ...
    if ($oldversion < 2013010400) {
        ...
        $field->set_attributes(XMLDB_TYPE_INTEGER, 1, XMLDB_INT, XMLDB_NOTNULL, null, 1);
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
        }
