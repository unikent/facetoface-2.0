...
class attendance_taken extends \core\event\base
{
    ...
    public static function get_name() {
        return "Facetoface Attendance Taken";
    }
    ...
    public function get_description() {
        return 'User took attendance for Facetoface module \'' . $this->objectid . '\'.';
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->objectid, 'facetoface', 'take attendance', 'view.php?id=' . $this->objectid, '');
    }
}