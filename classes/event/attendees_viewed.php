...
class attendees_viewed extends \core\event\base
{
    ...
    public static function get_name() {
        return "Facetoface Attendees Viewed";
    }
    ...
    public function get_description() {
        return 'User viewed attendees for Facetoface module \'' . $this->objectid . '\'.';
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->objectid, 'facetoface', 'view attendees', 'view.php?id=' . $this->objectid, '');
    }
}